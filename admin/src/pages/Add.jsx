...
const Add = ({token}) => {
  ...
  const [sizes, setSizes] = useState([]); //儲存選擇陣列
  ...
  try {
    ...
    formData.append("sizes", JSON.stringify(sizes)); //陣列轉字串傳送
    ...
    formData,
    {headers:{token}} //從app.jsx傳下來的token
  );
  ...
  return (
    ...
    className="flex flex-col w-full gap-3">
      ...
      <div className="w-full">
        ...
        <input
          className="w-full max-w-125 px-3 py-2 required"
          type="text"
      ...
      <div className="flex gap-2 mt-2 items-center">
        ...
        onChange={() => {
        console.log("目前的 bestseller 狀態:", !bestseller);
      ...
      <button className="cursor-pointer bg-black text-white py-2 w-28 mt-4">Add</button>
